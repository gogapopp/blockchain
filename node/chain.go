...
const godSeed = "d69559ae38348059ca7bf53256646916f6bc0130b0028100c9e396dd07a81b89"
...
func (c *Chain) ValidateBlock(b *proto.Block) error {
	...
	if !bytes.Equal(hash, b.Header.PrevHash) {
		return fmt.Errorf("invalid previous block has")
	}
...
func (c *Chain) ValidateTransaction(tx *proto.Transaction) error {
	...
	for i := 0; i < nInputs; i++ {
		...
		if utxo.Spent {
			return fmt.Errorf("output %d of tx %s is alredy spent", i, hash)
		}
	}
